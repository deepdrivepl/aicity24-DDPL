...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='test_challenge.json',
        backend_args=None,
        data_prefix=dict(img='test-challenge/'),
        data_root='/aicity/data/FishEye8K/',
        metainfo=dict(
            classes=(
                'Bus',
...
test_evaluator = dict(
    type='CocoMetric',
    ann_file='/aicity/data/FishEye8K/test_challenge.json',
    format_only=True,
    metric=['bbox'],
    outfile_prefix='/aicity/results/FishEye8K/mmdet/codetr/004-960-FishEye8k_VD_UAVDT_WD_aug-co_dino-swinl-16-detr-bs4/test-challenge'
)
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
train_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='train_VD-distorted-aug_UAVDT-distorted-aug_WoodScapes-aug_FE8K-aug-orig-fractal.json',
        backend_args=None,
