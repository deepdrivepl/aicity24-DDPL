...
data_root = '/aicity/data/FishEye8K/'
...
jsonfile_prefix = '/aicity/results/FishEye8K/mmdet/codetr/004-960-FishEye8k_VD_UAVDT_WD_aug-co_dino-swinl-16-detr-bs4/test'
launcher = 'none'
load_from = '/aicity/results/FishEye8K/mmdet/codetr/004-960-FishEye8k_VD_UAVDT_WD_aug-co_dino-swinl-16-detr-bs4/epoch_3.pth'
load_pipeline = [
...
test_evaluator = dict(
    ann_file='/aicity/data/FishEye8K/test/test.json',
    format_only=True,
    metric=[
        'bbox',
    ],
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'train_VD-distorted-aug_UAVDT-distorted-aug_WoodScapes-aug_FE8K-aug-orig-fractal.json',
        backend_args=None,
        data_prefix=dict(img='images/'),
        data_root='/aicity/data/mmdet-coco/',
...
val_evaluator = dict(
    _scope_='mmdet',
    ann_file='/aicity/data/FishEye8K/val/val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
